...
$toemails[] = array(
				'email' => 'contentxdesignstrategy@gmail.com', // Your Email Address
				'name' => 'Jennifer Roth' // Your Name
			);
...
$fromemail = array(
				'email' => 'no-reply@contentxdesignstrategy.com', // Company's Email Address (preferably currently used Domain Name)
				'name' => 'Content x Design' // Company Name
			);
